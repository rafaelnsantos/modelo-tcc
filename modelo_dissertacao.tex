...
\diretoria{Diretoria de Computação}
\coordenacao{Diretoria de Graduação e Educação Profissional}
...
\coorientador[Co-orientadora]{Profa. Dra.}{José Antonio} % <- no caso de co-orientadora, usar esta sintaxe
