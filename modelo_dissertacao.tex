...
\titulo{Título em Português} % titulo do trabalho em português
\title{Title in English} % titulo do trabalho em inglês
\autor{Rafael Nascimento dos Santos} % autor do trabalho
...
\comentario{\UTFPRdocumentodata\ apresentado ao \UTFPRcoordenacaodata\ da \UTFPRinstituicaodata\ como requisito parcial para obtenção do título de ``\UTFPRtitulacaodata\ em \UTFPRareadata''.}
...
\textoaprovacao{Esta \UTFPRdocumentodata\ foi julgada adequada para obtenção do Título de ``\UTFPRtitulacaodata\ em \UTFPRareadata'' e aprovado em sua forma final pelo \UTFPRcoordenacaodata\ da \UTFPRinstituicaodata.}
...
\datadefesaUTFPR{29}{07}{2018} %% A data deve ser inserida no formato dd/mm/aaaa
